...
$u = "https://github.com/dong065vn/dashboardtool/raw/refs/heads/main/caidat/caidatphanmem.exe"
$f = "$env:TEMP\caidatphanmem.exe"

Write-Host "Dang tai file tu folder 'caidat'..." -ForegroundColor Cyan
