...
$u = "https://github.com/dong065vn/dashboardtool/raw/refs/heads/main/saoluu/saoluu.exe"
$f = "$env:TEMP\saoluu.exe"

Write-Host "Dang tai file tu folder 'saoluu'..." -ForegroundColor Cyan
